...
<head>
  ...
  <title>Digitear | Distributeurs</title>
  ...
  <!-- Code JS permettant d'afficher / de cacher la légende -->
  <script>
	$(document).ready(function(){
		$(".display").click(function(){
			if($(".lgd").is(":hidden")){
				$(".lgd").slideDown(400);
				document.getElementById('display').textContent = "Masquer la légende";
			} else {
				$(".lgd").slideUp(400);
				document.getElementById('display').textContent = "Afficher la légende";
			}
		}
	);
});
...
<body>
  ...
  <?php include('nav.php'); ?> 
    ...
    <div id="backButton" onClick="backButtonClick();">Retour</div>
	...
	<br />
	<center><button id="display" class="display">Afficher la légende</button></center>
	<center>
	<div class="lgd" hidden> <!-- div caché lors du premier affichage -->
		<hr width="80%">
