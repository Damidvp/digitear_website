...
<div class="container">
 <div class="row">
  <div class="col-md-6">
            ...
            <h4>Boîtier compact assurant la communication sans-fil entre le réseau Digitear et l'oreillette <a href="inear.php">InEar</a> ainsi que les fonctions de sélection de canal, réglages, et Talk-Back.</h4>
            </p>
            </div>
          </div>
  <div class="col-md-6">
            ...
            <h4><li><b>Codec audio</b> APTX</li>
            <li><b>Bluetooth</b> 4.2</li>
            <li><b>Wifi</b> 802.11n</li>
            <li><b>Autonomie</b> environ 6 heures</li>
            <li>Sélection <b>source</b> et <b>gain</b> micro</li>
            <li>Visualisation des niveaux des batteries du <a href="beltpack.php">Beltpack</a> et du <a href="inear.php">InEar</a></li>
            <li>Mémorisation de deux <a href="inear.php">InEar</a></li>
            <li><b>Portée</b> jusqu'à 50 mètres en Wifi, jusqu'à 10 mètres en Bluetooth</a></li>
            <li><b>Connexion automatique</b> au <a href="inear.php">InEar</a></a></li>
            <li>Connexion à deux <a href="inear.php">InEar</a> simultanément (<b>Dual Stream</b>)</li>
            <li><b>Poids</b> 60 grammes avec batterie</li></h4>
