...
<div class="container">
 <div class="row">
  <div class="col-md-6">
            ...
            <h4>Oreillette sans-fil, intra auriculaire recevant le flux audio numérique du <a href="beltpack.php">Beltpack</a>.</h4>
  ...
  <div class="col-md-6">
            ...
            <h4><li><b>Codec audio APTX</b> son numérique de haute qualité</li>
            <li><b>Bluetooth</b> 4.2</li>
            <li><b>Portée</b> < 10m depuis le <a href="beltpack.php">Beltpack</a></li>
            <li><b>Autonomie</b> : 3 heures en fonctionnement - 6 heures en Eco Mode (Taux d'utilisation 30%)</li>
            <li><b>Dimensions</b> : 19.5 x 15 x 9 mm</li>
            <li><b>Poids</b> : 4 grammes</li></h4>
