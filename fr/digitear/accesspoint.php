...
<div class="container">
 <div class="row">
  <div class="col-md-6">
            ...
            <h4>Point d'accès radio assurant la liaison sans fil des <a href="beltpack.php">Beltpack</a> au réseau Digitear.</h4>
            </p>
            </div>
          </div>
  <div class="col-md-6">
            ...
            <h4><li><b>Type alimentation</b> : POE (802.3 at/af)</li>
            <li><b>Lieu d'utilisation</b> : intérieur</li>
            <li><b>Portée champ libre</b> : 50m maximum</li>
            <li><b>Transfert automatique</b> des <a href="beltpack.php">Beltpack</a> entre AccessPoint (roaming)</li></h4>
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="avertissement">
       <p><img src="img/info.png" alt="info" style="height:17px; width:17px;"></img><b>  Information : </b></p>
       <p> L'AccessPoint est une antenne assurant la liaison entre les <a href = "beltpack.php">Beltpack</a> et les <a href="txbox.php">TX-Box</a>. L'antenne fournie est fabriquée par MikroTik, puis distribuée par ses partenaires.</p>
       <p>Overline Systems n'est pas distributeur de cette antenne, mais applique une configuration spéciale sur cette dernière pour optimiser son utilisation dans le cadre du Digitear, exclusivement.</p>
