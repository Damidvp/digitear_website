...
<div class="container">
 <div class="row">
  <div class="col-md-6">
            ...
            <h4>La ChargerBox permet de recharger un ensemble complet de récepteurs sans-fil à savoir un <a href = "beltpack.php">Beltpack</a>, deux oreillettes <a href="inear.php">InEar</a> et une batterie <a href="beltpack.php">Beltpack</a> de rechange.</h4>
            </p>
            </div>
          </div>
  <div class="col-md-6">
            ...
            <h4><li><b>Temps de recharge InEar</b> 2h</li>
            <li><b>Temps de recharge Beltpack et batterie de rechange</b> 3h</li>
            <li><b>Fourni</b> avec batterie de rechange et chargeur mini USB</li>
            <li>Dispose d'un mode <b>nomade</b> permettant la recharge des InEar grâce à la batterie de rechange du Beltpack</li></h4>
...
<div class="container">
  <div class="row">
      <div class="doc">
       ...
       <div class="col-lg-12"><h2><b>DOCUMENTOS TECHNIQUES</b></h2><br/></div>
	   <div class="col-lg-12">
	  <ul>
