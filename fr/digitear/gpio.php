...
<ol class="carousel-indicators">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img class="img-responsive" src="img/quelquechose.jpg" alt="accesspoint" style="height:70%; width:70%;">
    ...
    <div class="item">
      <img class="img-responsive" src="img/autrechose.jpg" alt="accesspoint" style="height:70%; width:70%;">
      <div class="carousel-caption">
      <h1></h1>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-sm-6">
      <div class="doc">
       ...
       <h2><b>DOCUMENTS TECHNIQUES</b></h2>
       <li><i class="material-icons">picture_as_pdf</i><a href="doc/unpdf.pdf">???</a></li>
