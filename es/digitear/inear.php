...
<div class="container">
 <div class="row">
  <div class="col-md-6">
            ...
            <h4>Auricular sin cable, recibe el flujo de audio numérico del <a href="beltpack.php">Beltpack</a>.</h4>
            </p>
            </div>
          </div>
  <div class="col-md-6">
            ...
            <h4><li><b>Codec audio APTX</b> sonido numérico de alta calidad</li>
            <li><b>Bluetooth</b> 4.2</li>
            <li><b>Rango</b> < 10 metros desde el <a href="beltpack.php">Beltpack</a></li>
            <li><b>Autonomía</b>: 3 horas en funcionamiento - 6 horas en Eco Mode (Taza de utilización 30%)</li>
            <li><b>Dimensiones</b>: 19.5 x 15 x 9 mm (49 ⁄ 64in x 38 ⁄ 64in x 23 ⁄ 64in)</li>
            <li><b>Peso</b>: 4 gramos</li></h4>
            </div>
  </div>
 </div>
</div>
