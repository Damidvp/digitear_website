...
<title>Digitear | Descargas </title>
  ...
  <a class="navbar-brand" href="../index.php"><img src="img/logo.png" alt="Overline Systems"></a>
   ...
   <div class="collapse navbar-collapse" id="myNavbar">
    <ul class="nav navbar-nav">
      ...
      <li style="font-size:1.2em; font-weight:bold;" class="active" ><a href="dl.php">Descargas</a></li>
...
<div class="container-fluid">
	...
	<div class="titlepage">
	 <br />
	  <center><h1><span><b>DESCARGAS</b></span></h1>
	  <hr style="width:75%">
	  <br />
  ...
  <div class="row_doc">
	  ...
	  <b style="font-size:18px">Guía del usuario (<img src="../flag/fr.png" alt="FR"/>)</b>
	  <p><i>(517 Ko)</i></p>
	  </li>
	  </a> 
	  <a href="doc/DOC_INEAR_EN_250319.pdf">
	  <li style="list-style-type: none;">
	  <b style="font-size:18px">Guía del usuario (<img src="../flag/gb.png" alt="EN"/>)</b>
	  <p><i>(516 Ko)</i></p>
	  </li>
	  </a>
	  <a href="doc/DOC_INEAR_ES_120619.pdf">
	  <li style="list-style-type: none;">
	  <b style="font-size:18px">Guía del usuario (<img src="../flag/es.png" alt="ES"/>)</b>
	  <p><i>(516 Ko)</i></p>
	  </li>
	  </a>
	  <a href="doc/DENR-en.pdf">
      <li style="list-style-type: none;">
	  <b style="font-size:18px">Ficha técnica</b>
	  <p><i>(95 Ko)</i></p>
	  </li>
	  </a>
      </ul>
...
<div class="container-fluid">
  ...
  <div class="row_doc">
       ...
       <div class="doc">
	   <ul>
	   <a href="doc/SCHEMAEN.pdf">
       <li style="list-style-type: none;">
	   <b style="font-size:18px">Esquema de principio</b>
	   <p><i>(1 967 Ko)</i></p>
	   </li>
	   </a>
	   </ul>
