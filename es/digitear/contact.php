...
<title>Digitear | Contactarnos</title>
  ...
  <div class="row">
      <div class="col-md-9">
        <div class="well well-sm">
          ...
          <fieldset>
            <legend class="text-center">Contactarnos</legend>
            ...
            <div class="form-group">
              <div class="col-md-12 text-right">
                <button type="submit" class="btn btn-primary btn-lg" name="envoi" value="Send the form">Enviar</button>
              </div>
            </div>
          </fieldset>
          </form>
