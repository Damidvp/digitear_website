...
<title>Digitear | AccessPoint</title>
  ...
  <link href="accesspointtxt.css" rel="stylesheet" type="text/css">
...
<ol class="carousel-indicators">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img class="img-responsive" src="img/AU.jpg" alt="accesspoint" style="height:70%; width:70%;">
    ...
    <div class="item">
      <img class="img-responsive" src="img/AU2.jpg" alt="accesspoint" style="height:70%; width:70%;">
      <div class="carousel-caption">
      <h1></h1>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="avertissement">
       ...
       <p><img src="img/info.png" alt="info" style="height:17px; width:17px;"></img><b>  Información : </b></p>
       <p> El AccessPoint es una antena que asegura la conexión entre los <a href = "beltpack.php">Beltpacks</a> y las <a href="txbox.php">TX-Box</a>. La antena proporcionada es fabricada por MikroTik, luego es distribuida por sus asociados.</p>
       <p>Overline Systems no es distribuidor de esta antena, pero aplica una configuración especial para optimizar su utilización en la red Digitear exclusivamente.</p>
...
<div class="container">
 <div class="row">
  <div class="col-md-6">
            ...
            <h4>Punto de acceso que asegura la conexión inalámbrica entre los <a href = "beltpack.php">Beltpacks</a> y la red Digitear.</h4>
            </p>
            </div>
          </div>
  <div class="col-md-6">
            ...
            <h4><li><b>Tipo de alimentación</b>: POE (802.3 at/af)</li>
            <li><b>Lugar de utilización</b>: espacios interiores</li>
            <li><b>Rango en campo abierto</b>: alrededor 50 metros (160 feet)</li>
            <li><b>Transferencia automática</b> de <a href="beltpack.php">Beltpacks</a> entre los AccessPoint (roaming)</li></h4>
