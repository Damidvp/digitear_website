...
function zoomInOnContinent (dX,dY,dS) {
	...
	$('#directions').text('Selecciona su país');
...
function zoomOutOnContinent (dX,dY,dS) {
	...
	$('#directions').text('Seleccionna su continente');
...
function displayBoxText (cc) {
	if(countrySelected){
		...
		if(selectedRegion == currentRegionSelected){
			...
			if(terms == null){
				$('#program-holder').append('<b><div class="term-programs center-text">Currently, Overline Systems does not have a local distributor. Please contact our head office.<div> Phone : +33 (0)5 57 70 21 21 <div> Mail : sales@overline-systems.com</div></b></div> ');
			}else{
				if(terms.yrsem != null){
				...
				if(terms.Italie != null){
					...
					programInfo.forEach(function (value, i) {
					    if(i%2 == 0)
					    	$('#program-holder').append('<a class="program-link" href=' + programInfo[i+1] + '><img src="img/digitear.png"></a><b><div class="program-name center-left">Leading Technologies</div><div class="program-name center-left">Via Solferino, 54</div><div class="program-name center-left">20900 Monza MB, Italie</div><div class="program-name center-left">Phone : +39 039 941 5200</div><div class="program-name center-left">Website : <a href="http://www.leadingtech.it">http://www.leadingtech.it</a>' + value + '</b></div></div></div></div>');
					});
					$('#program-holder').append('</div>');
				}
				if(terms.Espagne != null){
					...
					programInfo.forEach(function (value, i) {
					    if(i%2 == 0)
					    	$('#program-holder').append('<a class="program-link" href=' + programInfo[i+1] + '><img src="img/digitear.png"></a><b><div class="program-name center-left">Coel Audio Solutions</div><div class="program-name center-left">Barrio Elizalde, Nº 25 Pabellón 10</div><div class="program-name center-left">48213 Izurza, Vizcaya</div><div class="program-name center-left">Phone :  +34 946 202 338</div><div class="program-name center-left">Website : <a href="http://www.coelaudio.com">http://www.coelaudio.com</a>' + value + '</b></div></div></div></div></div>');
					});
					$('#program-holder').append('</div>');
				...
				if(terms.Sonotechnique != null){
					...
					programInfo.forEach(function (value, i) {
					    if(i%2 == 0)
					    	$('#program-holder').append('<a class="program-link" href=' + programInfo[i+1] + '><img src="img/digitear.png"></a><b><div class="program-name center-left">Sonotechnique</div><div class="program-name center-left">200 Gince Street Montreal,</div><div class="program-name center-left">Canada</div><div class="program-name center-left">Phone Montreal:  (514)332-6868</div><div class="program-name center-left">Phone Toronto:  (416)947-9112</div><div class="program-name center-left">Phone Vancouver:  (604)461-2202</div><div class="program-name center-left">Website : <a href="http://www.sonotechnique.ca/">http://www.sonotechnique.ca/</a>' + value + '</b></div></div></div></div></div>');
					});
					$('#program-holder').append('</div>');
				}
				...
				if(terms.Maroc != null){
					...
					programInfo.forEach(function (value, i) {
					    if(i%2 == 0)
					    	$('#program-holder').append('<a class="program-link" href=' + programInfo[i+1] + '><img src="img/digitear.png"></a><b><div class="program-name center-left">LTS Network</div><div class="program-name center-left">377, rue Mustapha El Mâani, 1st floor</div><div class="program-name center-left">20140 Casablanca</div><div class="program-name center-left">Phone : +212 (0)5 22 48 20 28</div><div class="program-name center-left">Website : <a href="http://www.lts-network.com">http://www.lts-network.com</a>' + value + '</b></div></div></div></div>');
					});
					$('#program-holder').append('</div>');
				}
				if(terms.Chine != null){
				...
				if(terms.Ukraine != null){
					...
					programInfo.forEach(function (value, i) {
					    if(i%2 == 0)
					    	$('#program-holder').append('<a class="program-link" href=' + programInfo[i+1] + '><img src="img/digitear.png"></a><b><div class="program-name center-left">Cinema Pro Ltd.</div><div class="program-name center-left">Rivne, Danyla Galiskogo str., 9</div><div class="program-name center-left">33027 Rivne</div><div class="program-name center-left">Phone : +38 (098) 502-38-46 </div><div class="program-name center-left">Website : <i>None</i> ' + value + '</b></div></div></div></div>');
					});
					$('#program-holder').append('</div>');
				}
				if(terms.Qatar != null){
					...
					programInfo.forEach(function (value, i) {
					    if(i%2 == 0)
					    	$('#program-holder').append('<a class="program-link" href=' + programInfo[i+1] + '><img src="img/digitear.png"></a><b><div class="program-name center-left">Gulf Broadcast Technology</div><div class="program-name center-left">Bin Omran Town Center Building 1</div><div class="program-name center-left">Doha</div><div class="program-name center-left">Phone : +974 4483 69 55 </div><div class="program-name center-left">Website : <a href="http://gulfbt.com">http://gulfbt.com</a> ' + value + '</b></div></div></div></div>');
					});
					$('#program-holder').append('</div>');
				}
				if(terms.BroadcastCommunicationsInternational != null){
					...
					programInfo.forEach(function (value, i) {
					    if(i%2 == 0)
					    	$('#program-holder').append('<a class="program-link" href=' + programInfo[i+1] + '><img src="img/digitear.png"></a><b><div class="program-name center-left">Broadcast Communications International</div><div class="program-name center-left">7030 Ang Mo Kio Ave 5 #06-06</div><div class="program-name center-left">569880 Singapore</div><div class="program-name center-left">Phone : (65) 6255 1808 </div><div class="program-name center-left">Website : <a href="http://www.bci.com.sg">http://www.bci.com.sg</a> ' + value + '</b></div></div></div></div>');
					});
					$('#program-holder').append('</div>');
				}
			}
