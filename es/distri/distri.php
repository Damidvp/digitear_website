...
<head>
  ...
  <title>Digitear | Distribuidores </title>
  ...
  <script>
	$(document).ready(function(){
		$(".display").click(function(){
			if($(".lgd").is(":hidden")){
				$(".lgd").slideDown(400);
				document.getElementById('display').textContent = "Esconder la leyenda del mapa";
			} else {
				$(".lgd").slideUp(400);
				document.getElementById('display').textContent = "Mostrar la leyenda del mapa";
			}
		}
	);
});
...
$(document).ready(function(){
  ...
  jQuery(document).ready(function() {
    ...
    $('#directions').text('Selecciona su continente');
...
<body>
  ...
  <?php include('nav.php'); ?> 
    ...
    <div id="backButton" onClick="backButtonClick();">Volver</div>
	...
	<br />
	<center><button id="display" class="display">Mostrar la leyenda del mapa</button></center>
	<center>
