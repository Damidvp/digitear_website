...
<div class="container">
 <div class="row">
  <div class="col-md-6">
            ...
            <h4>The 2U format base ensures the transmission of 8 full-duplex audio channels between its 8 analog inputs/outputs and the Digitear digital network.</h4>
            </p>
            </div>
          </div>
  <div class="col-md-6">
            ...
            <h4><li><b>8 full-duplex audio channels</b> on the Digitear network </li>
            <li><b>Remote control</b> from a PC app connected to the network</li>
            <li><b>Principal functions :</b>
            <div class="tabulation"><p>- Gain of analog audio inputs and outputs</p>
            <p>- Level of latency/robustness of the radio signal</p>
            <p>- Visualization of the <a href = "beltpack.php">Beltpack</a> and <a href = "inear.php">InEar</a> batteries levels</p>
            <p>- Visualization of input audio levels</p></li>
            <li><b>Weight</b> 4 kg (8lb)</li></div></h4>
