...
<div class="container">
 <div class="row">
  <div class="col-md-6">
            ...
            <h4>Compact Beltpack ensuring wireless communication between the Digitear network  and the <a href="inear.php">InEar</a>. This includes channel selection, settings, and Talk-Back functions.</h4>
            </p>
            </div>
          </div>
  <div class="col-md-6">
            ...
            <h4><li><b>APTX Audio Codec</b> .</li>
            <li><b>Bluetooth</b> 4.2</li>
            <li><b>Wifi</b> 802.11n</li>
            <li><b>Autonomy</b> approx. 6 hours</li>
            <li><b>Source</b> selection and microphone <b>gain</b></li>
            <li><a href="beltpack.php">Beltpack</a> and the <a href="inear.php">InEar</a> battery levels</li> 
            <li>Memorization of two <a href="inear.php">InEar</a></li>
            <li>Approx. <b>50 meters (160 feet)</b> via Wifi, approx. 10 meters (30 feet) via Bluetooth</a></li>
            <li><b>Automatic link</b> to <a href="inear.php">InEar</a></a></li>
            <li><b>Dual Stream</b> possible with two <a href="inear.php">InEar</a></li>
            <li><b>Weight</b> 60 grams (2 ounces) with battery</li></h4>
            </div>
  </div>
 </div>
</div>
