...
<title>Digitear | Demonstration</title>
...
<div class="container text-center">
  <div class="row">
    <div class="col-lg-8 col-md-8 col-lg-offset-2 col-md-offset-2">
          ...
          <h3><p>Our sales team is at your service to offer demonstrations of our Digitear system.</p></h3>
...
<div class="container text-center">
  <div class="row">
    <div class="col-lg-8 col-md-8 col-lg-offset-2 col-md-offset-2">
          ...
          <h3><p>Simply contact us by filling out the following form :</p></h3>
        ...
        <div class="well well-sm">
          ...
          <fieldset>
			...
			<div class="form-group">
              ...
              <div class="col-md-9">
                <input id="objet" name="objet" type="text" placeholder="Enter your subject" class="form-control">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <textarea class="form-control" id="message" name="message" placeholder="Enter a message, and your availability..." rows="5"></textarea>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-md-12 text-right">
                <button type="submit" class="btn btn-primary btn-lg" name="envoi" value="Envoyer le formulaire">Send</button>
              </div>
            </div>
          </fieldset>
          </form>
...
<div class="container text-center">
  <div class="row">
    <div class="col-lg-8 col-md-8 col-lg-offset-2 col-md-offset-2">
        ...
        <h3><p>We will then contact you to schedule an appointment based on your availability.</p></h3>
