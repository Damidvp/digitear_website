  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="avertissement">
       ...
       <p> The AccessPoint is a radio antenna ensuring the communication between the <a href = "beltpack.php">Beltpack</a> and the <a href="txbox.php">TX-Box</a>. The supplied antenna is manufactured by MikroTik and distributed by its partners.</p>
       <p>Overline Systems has applied a specific configuration to the antenna in order to optimize its exclusive use within the Digitear framework.</p>
...
<div class="container">
 <div class="row">
  <div class="col-md-6">
            ...
            <h4>Radio access point to establish a wireless communication between <a href = "beltpack.php">Beltpack</a> and the Digitear network.</h4>
            </p>
            </div>
          </div>
  <div class="col-md-6">
            ...
            <h4><li><b>Power supply</b>: POE (802.3 at/af)</li>
            <li><b>Place of use</b>: indoor</li>
            <li><b>Open field range</b>: approx. 50 meters (160 feet)</li>
            <li><b>Automatic roaming</b> of the <a href="beltpack.php">Beltpack</a></li></h4>
